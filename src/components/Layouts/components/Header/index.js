                    ...
                    <div className="flex basis-full justify-center">
                        <div className="xl:w-3/4">
                            <div className="input-group relative flex flex-wrap items-stretch w-full">
                                ...
                                <button className="absolute top-0 right-0 bottom-0 btn inline-block px-5 py-1.5 bg-teal-500 text-white text-xs leading-tight rounded-full shadow-md hover:bg-teal-700 hover:shadow-lg focus:bg-teal-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-teal-800 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
